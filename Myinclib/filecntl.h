...
int     fcntl_dmp(struct FileControl *fcntl, char *msg);
...
int     f_open(struct FileControl *fcntl, char *mode)
{
        ...
        if(strcmp(fcntl->s_recfm, "F")) {
                fcntl->recfm    =   RECFM_F;
        } else if(strcmp(fcntl->s_recfm, "FB")) {
                fcntl->recfm    =   RECFM_FB;
        } else if(strcmp(fcntl->s_recfm, "V")) {
                fcntl->recfm    =   RECFM_V;
        } else if(strcmp(fcntl->s_recfm, "VB")) {
                fcntl->recfm    =   RECFM_VB;
        } else if(strcmp(fcntl->s_recfm, "T")) {
                fcntl->recfm    =   RECFM_T;
        } else if(strcmp(fcntl->s_recfm, "C")) {
                fcntl->recfm    =   RECFM_C;
        } else {
                fcntl->recfm    =   -1;
        }
